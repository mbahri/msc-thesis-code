...
% build_names  = {'mmx_mkl_single'};
%build_names  = {'mmx_mkl_multi','mmx_naive'};
   ...
   switch arch
      ...
      case {'glnxa64','glnx86'}
         ...
         switch name
            ...
            case 'mmx_mkl_single'
               ...
               if strcmp(arch,'glnx86')
                link_dir  = [root '/lib/intel64'];
                link     = {'mkl_sequential','pthread'};
                define   = {'UNIX_SYSTEM', 'USE_BLAS', 'MKL_32'};
               else
                link_dir  = ['/homes/mb2215/mkl'];
      ...
      case {'maci64'}
         switch name
            ...
            case 'mmx_mkl_single'
               root     = '/usr/local/opt/openblas';
               inc_dir  = [ root '/include'];
               link_dir = [root '/lib'];
               link     = {'openblas', 'lapack', 'pthread'};
