...
xlim(norminv([2.2421e-05 0.7])); % xlim(norminv([2.2421e-05 0.8318]));
ylim(norminv([0.05 0.9998])); % ylim(norminv([0.0364 0.9998]));
set(fig, 'PaperPositionMode', 'auto'); 
saveas(fig, fullfile(savepath, 'ten_highway_roc_curves_parula.eps'), 'epsc');
saveas(fig, fullfile(savepath, 'ten_highway_roc_curves_parula_nb.eps'), 'eps');
...
print(fig, '-depsc', fullfile(savepath, 'ten_highway_roc_curves_parula'));
print(fig, '-deps', fullfile(savepath, 'ten_highway_roc_curves_parula_nb'));
