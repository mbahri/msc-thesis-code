function [out] = MSIQA_255(imagery1, imagery2)
...
% by Yi Peng
%
% Modified by Mehdi bahri - Imperial College London
%==========================================================================
...
fsim = 0;
for i = 1:k
    psnr = psnr + PSNR(imagery1(:, :, i), imagery2(:, :, i));
...
out.ergas = ErrRelGlobAdimSyn(imagery1, imagery2);
out.msam = SpectAngMapper(imagery1, imagery2);
