...
saveas(fig_err_psnr_30, 'synth_30_error', 'epsc');
...
saveas(fig_err_psnr_60, 'synth_60_error', 'epsc');
...
saveas(fig_structure_30, 'synth_30_structure', 'epsc');
...
saveas(fig_structure_60, 'synth_60_structure', 'epsc');
