function [] = plot_yale_patch(noise_level, raw)
...
%%%%% NO MEAN VERSION OF THE 2D MODELS

fprintf('Loading Mehdi without mean estimator...\n');
method = 'mehdi_no_mean';
to_load = sprintf('/vol/bitbucket/mb2215/Thesis/Results/%s/2D_no_mean/results_%s_%s_%s_%f.mat', subfolder, dataset, method, noise_type, noise_level);
load(to_load)
[measures.rpca2d_l1_nm, best.rpca2d_l1_nm] = distilate(results_mehdi.rpca2d_l1, 'lambda', 0);
[measures.rpca2d_l2_nm, best.rpca2d_l2_nm] = distilate(results_mehdi.rpca2d_l2, 'lambda', 0);
clear results_mehdi;

method = 'mehdi_no_mean_gl_l1';
to_load = sprintf('/vol/bitbucket/mb2215/Thesis/Results/%s/2D_no_mean/results_%s_%s_%s_%f.mat', subfolder, dataset, method, noise_type, noise_level);
load(to_load)
[measures_2d.rpca2d_gl_l1_nm, best_2d.rpca2d_gl_l1_nm] = distilate_2d(results_mehdi.rpca2d_gl_l1, 'lambda', 'alpha');
clear results_mehdi;

method = 'mehdi_no_mean_gl_l2';
to_load = sprintf('/vol/bitbucket/mb2215/Thesis/Results/%s/2D_no_mean/results_%s_%s_%s_%f.mat', subfolder, dataset, method, noise_type, noise_level);
load(to_load)
[measures_2d.rpca2d_gl_l2_nm, best_2d.rpca2d_gl_l2_nm] = distilate_2d(results_mehdi.rpca2d_gl_l2, 'lambda', 'alpha');
clear results_mehdi;
...
load( sprintf('preprocess_%s_%s_%f.mat', dataset, noise_type, noise_level) );

end

algorithms = {'ten_rpca',  'ten_brpca', 'ten_orpca', 'ten_rcpd', ...
              'rpca2d_l1', 'rpca2d_l2', 'rpca2d_l1_nm', 'rpca2d_l2_nm'...
              'cvpr2016_tnn', 'brtf', 'horpca_s', 'horpca_s_tc', 'cvpr2014_tsvd'};
algorithms_2d = {'rpca2d_gl_l1', 'rpca2d_gl_l2', 'rpca2d_gl_l1_nm', ...
              'rpca2d_gl_l2_nm', 'welsh_st', 'cauchy_st', 'nctrpca'};
...
legend_names = {'Tensor RPCA (Papamakarios et. al.)', ...
                ...
                '2D RPCA L1 w/ mean (Bahri et. al.)', ...
                '2D RPCA L2 w/ mean (Bahri et. al.)', ...
                ...
                '2D RPCA GL L1 w/ mean (Bahri et. al.)', ...
                '2D RPCA GL L2 w/ mean (Bahri et. al.)', ...
...
parameters_st = {...
    ...
    '$\lambda$', '$\lambda$', '$\lambda$', '$\lambda$', 'IV', '$\lambda$', '$\lambda$', ...
